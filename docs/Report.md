...
Here we can see they start with about the same number, so 155 to 239 tumor voxels. The ratio is at 1.5x more for the smoker person. 
...
At t=60 days, we can start to see the difference in progression of cells. The healthy person has 1958 voxels and the smoker one has 3935. The smoker has twice as much tumor cells.
...
At t=120 days, the difference is flagrant, the smoker has 10401 and the healthy one 4616, so the smoker has 2.25x more tumor cells. 

<img src="images/csv_healthy.png" alt="Healthy values" width="400">
<img src="images/csv-smoker.png" alt="Smoker values" width="400">
In these values, generated by our C code we can start to see how the progression differs between the two but it's visualisation is far less impacting, being just numbers. 

Evoluting from 1.5x more to 2.25x more we see the progression for the smoker is utterly bigger. Thus proving our initial point, the visualisation helps us really make the difference on the impact the lifestyle one choses to live has on its health. 
