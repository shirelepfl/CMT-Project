...
- r0 * 1.5 :  smoking and chronic inflammation increase reactive-oxygen species and mutation rate which will increase uncontrolled cell division to a factor ~ 50%; 
- D0 * 1.4: smoking increases: epithelial-mesenchymal transition (EMT, a process where normal epithelial cells lose their tight connections and become more mobile and invasive), the activity of matrix metalloproteinases (MMP-2 and MMP-9) and as a result, there is more collagen breakdown, which weakens tissue structure making tumor cells more mobile and able to invade lung tissue. A 40% increase matches typical modeling choices in metastasis & EMT studies;
- K0 * 1.3 : Nicotine stimulates angiogenesis, the formation of new blood vessels. As a result, the development of new capillaries is enhanced, which can support tissue repair but also contribute to disease progression. More blood supply induces more oxygen/nutrients which means higher cell density supported. A 30% increase is a literature-aligned estimate; 
